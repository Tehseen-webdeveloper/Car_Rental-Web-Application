        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <a href="tel:03275792600" className="text-sm font-semibold text-gray-900 hover:text-violet-600 transition-smooth">
                03275792600
              </a>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200 space-y-4 animate-fade-in">
              ...
              <a href="tel:03275792600" className="block text-violet-600 font-semibold" onClick={() => setMobileMenuOpen(false)}>
                03275792600
              </a>
            </div>
          )}
